...
var incompleteTaskHolder=document.querySelector(".incompleted-tasks-list");//ul of #incompleted-tasks-list
...
var createNewTaskElement=function(taskString){
    ...
    label.classList.add('task-item__inner', 'task-item__label');

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.classList.add('task-item__checkbox');
    editInput.type="text";
    editInput.classList.add('task-item__inner', 'task-item__input');
